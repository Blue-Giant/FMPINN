...
def solve_Multiscale_PDE(R):
    ...
    if R['testData_model'] == 'random_generate':
        ...
        saveData.save_testData_or_solus2mat(test_xyz_torch, dataName='testXYZ', outPath=R['FolderName'])
...
if __name__ == "__main__":
    ...
    if R['model2NN'] == 'Fourier_DNN':
        R['hidden_layers'] = (250, 400, 200, 200, 150)  # 250+500*400+400*400+400*200+200*200+200*150+150 = 510400
        ...
        R['hidden_layers'] = (500, 400, 200, 200, 150)  # 500+500*400+400*400+400*200+200*200+200*150+150 = 510650
