...
class FMPINN(tn.Module):
    def __init__(self, input_dim=4, out_dim=1, hidden_layer=None, Model_name='DNN', name2actIn='relu',
        ...
        self.DNN = DNN_base.Multi_8FF_DNN(
            ...
            repeat_Highfreq=repeat_highFreq, to_gpu=use_gpu, gpu_no=No2GPU, sigma1=1.0, sigma2=10.0,
            sigma3=20.0, sigma4=40.0, sigma5=60.0, sigma6=80.0, sigma7=100.0, sigma8=120.0)
    ...
    def loss_in2pLaplace(self, X=None, Y=None, fside=None, if_lambda2fside=True, aeps=None, if_lambda2aeps=True,
        ...
        # bundling the x and y, then feeding xy into the NN piplines for solu, Px and Py, obtaining the three solutions
        ...
        # calculating the gradients of UNN
        ...
        # calculating the gradients of PNNX and PNNY
...
def solve_Multiscale_PDE(R):
    ...
    if R['testData_model'] == 'random_generate':
        ...
        # size2test = 100
        test_xy_bach = dataUtilizer2torch.rand_in_2D(
            batch_size=test_bach_size, variable_dim=R['input_dim'], region_left=region_lb, region_right=region_rt,
            region_bottom=region_lb, region_top=region_rt, to_torch=False, to_float=True, to_cuda=False,
            gpu_no=R['gpuNo'])
