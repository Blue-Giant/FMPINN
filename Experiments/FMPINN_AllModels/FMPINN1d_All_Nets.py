...
def solve_Multiscale_PDE(R):
    ...
    # scheduler = torch.optim.lr_scheduler.StepLR(optimizer, 50, gamma=0.98)
    ...
    for i_epoch in range(R['max_epoch'] + 1):
        ...
        if i_epoch % 1000 == 0:
            ...
            test_h1_fenzi = torch.sum(torch.square(pointwise_err2solu), dim=0)+torch.sum(torch.square(pointwise_err2deri), dim=0)
...
if __name__ == "__main__":
    ...
    store_file = 'FMPINN_ALLNets_1D_New'
