...
if __name__ == "__main__":
    ...
    if R['model2NN'] == 'Fourier_DNN':
        ...
        R['hidden_layers'] = (30, 40, 30, 30, 30)    # 1*30+60*40+40*30+30*30+30*30+30*2= 5490（*24=131760）
        ...
        # R['hidden_layers'] = (250, 200, 100, 100, 80)  # 1*250+250*100+100*80+80*80+80*60+60*1= 44510 个参数
        R['hidden_layers'] = (250, 200, 150, 150, 100)  # 1*250+250*200+200*150+150*150+150*100+100*1= 117850 个参数
