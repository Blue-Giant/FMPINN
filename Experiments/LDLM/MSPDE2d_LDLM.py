...
def solve_Multiscale_PDE(R):
    ...
    for i_epoch in range(R['max_epoch'] + 1):
        ...
        #     gpu_no=R['gpuNo'])
        xy_it_batch = dataUtilizer2torch.rand_it_lhs(batchsize_it, R['input_dim'], region_a=region_lb, region_b=region_rt,
                                                     to_float=True, to_cuda=R['use_gpu'], gpu_no=R['gpuNo'],
                                                     use_grad2x=True)
...
if __name__ == "__main__":
    ...
    # R['equa_name'] = 'multi_scale2D_4'      # p=2 区域为 [-1,1]X[-1,1] 论文中的multi-frequency例子
    ...
    R['hidden_layers'] = (400, 250, 250, 200, 200)  # 400+400*250+250*250+250*200+200*200+200*3 = 253500

    # R['hidden_layers'] = (50, 80, 60, 60, 40)
    # R['hidden_layers'] = (50, 80, 60, 60, 30)
    # R['hidden_layers'] = (40, 60, 40, 40, 30)
    # R['hidden_layers'] = (40, 60, 40, 40, 40)     # 1*40+80*60+60*40+40*40+40*40+40*3=10560(*24=253440)
