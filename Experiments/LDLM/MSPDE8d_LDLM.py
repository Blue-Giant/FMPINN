...
if __name__ == "__main__":
    ...
    # &&&&&&&&&&&&&&&&&&&&&& 隐藏层的层数和每层神经元数目 &&&&&&&&&&&&&&&&&&&&&&&&&&&&
    R['hidden_layers'] = (400, 500, 300, 300, 300)  # 400+200000+150000+90000+90000+2400 = 532800

    R['hidden_layers'] = (60, 80, 60, 60, 60)       # 60+120*80+80*60+60*60+60*60+60*8=22140(*24=531360)
