...
def save_trainLoss2mat(loss, lossName=None, actName=None,outPath=None):
    outFile2data = '%s/%s2%s.mat' % (outPath, lossName, actName)
    key2mat = str.lower(lossName)
    scio.savemat(outFile2data, {key2mat: loss})
...
def save_testData_or_solus2mat(data, dataName=None, outPath=None):
    ...
    elif str.lower(dataName) == 'testxyzrstvw':
        outFile2data = '%s/testData2XYZRSTVW.mat' % (outPath)
        key2mat = 'Points2XYZST'
